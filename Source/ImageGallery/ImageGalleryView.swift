...
public class ImageGalleryView: UIView {
  ...
  lazy var selectedCellIndexes: [Int] = { [unowned self] in
    return [Int]()
    }()
  ...
  public func collectionView(collectionView: UICollectionView, didSelectItemAtIndexPath indexPath: NSIndexPath) {
    ...
    ImagePicker.resolveAsset(asset) { image in
      ...
      if cell.selectedImageView.image != nil {
        ...
        self.selectedCellIndexes.removeAtIndex(self.selectedCellIndexes.indexOf(indexPath.item)!)
        ...
        self.selectedCellIndexes.append(indexPath.item)
      } else if (self.imageLimit != 0 && self.imageLimit == self.selectedStack.assets.count) {
        let index = self.selectedCellIndexes.last!
